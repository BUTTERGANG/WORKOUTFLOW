...
export const users = pgTable("users", {
  ...
  index("idx_users_role").on(table.role), // For filtering by role
]);
...
export const programs = pgTable("programs", {
  ...
  index("idx_programs_is_template").on(table.organizationId, table.isTemplate), // Composite for template filtering
]);
...
export const programExercises = pgTable("program_exercises", {
  ...
  index("idx_program_exercises_order").on(table.dayId, table.order), // Composite index for ordering
]);
...
export const exerciseLogs = pgTable("exercise_logs", {
  ...
  index("idx_exercise_logs_order").on(table.sessionId, table.order), // Composite for ordering
]);
...
export const setLogs = pgTable("set_logs", {
  ...
  index("idx_set_logs_set_number").on(table.exerciseLogId, table.setNumber), // Composite for ordering sets
]);
